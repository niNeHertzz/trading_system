...
<div id="new-brand-dialog" class="modal fade " role="dialog">
                ...
                <div class="modal-header toast-info" 
                    ...
                    <h5 class="modal-title" 
                        style="color:#474646;font-family:calibri;
                               font-size:18px;font-weight:bold;">New Brand</h5>
                </div>
                <div class="modal-body">
                    <!-- <form method="post" id="new-category-form" action="insert.php"> -->
                        <div class="form-group" style="margin-left: 10px;">
                            <span class="new-brand-label">Brand</span>
                            <div class="col-sm-12" style="padding-left: 0px;margin-top: 5px;">
                                <input type="text" name="brandtxt" value="" class="form-control new-brand-txt" autocomplete="off" />
                            </div>
                        </div>
                        <div style="text-align: right;margin-right: 15px;">
                            <button id="new-brand-save" type="button" class="btn btn-default"
